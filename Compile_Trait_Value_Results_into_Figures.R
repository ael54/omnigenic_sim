  ...
  this.max.y.axis <- max(data.for.trait.value.scatterplot[,c(1:4, 9:12)])
   ...
   for(this.selection.type in unique(data.for.trait.value.scatterplot$subpopulation.vector)){
     for(this.selection.number in unique(data.for.trait.value.scatterplot$selection.number.vector)){
       ...
       source("/Users/alipka/Library/CloudStorage/Box-Box/Sabbatical_Roslin_Institute/R_workspace/omnigenic_sim/Functions_to_Make_Life_Easier/Make_Trait_Scatter_Plots_Traits.R")
       ...
       source("/Users/alipka/Library/CloudStorage/Box-Box/Sabbatical_Roslin_Institute/R_workspace/omnigenic_sim/Functions_to_Make_Life_Easier/Make_Trait_Scatter_Breeding_Values.R")
