...
if(plot.trait.1){
  the.plot.genetic.value.vc <- the.plot.genetic.value.vc  + geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(genetic.value.1.variance)), alpha = 0.1, col = "black")+
...
if(plot.trait.2){
  the.plot.genetic.value.vc <- the.plot.genetic.value.vc+geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(genetic.value.2.variance)), alpha = 0.1, col = "red")+
...
if(plot.trait.3){
  the.plot.genetic.value.vc <- the.plot.genetic.value.vc + geom_point(data= input.scatter.plot.data, aes(x = generation.vector,y= log(genetic.value.3.variance)), alpha = 0.1,  col = "blue" )+
...
if(plot.trait.4){
  the.plot.genetic.value.vc <- the.plot.genetic.value.vc + geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(genetic.value.4.variance)), alpha = 0.1, col = "purple")+
