...
if(plot.trait.1){
  the.plot.trait.vc <- the.plot.trait.vc  + geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(trait.1.variance)), alpha = 0.01, col = "black")+
...
if(plot.trait.2){
  the.plot.trait.vc <- the.plot.trait.vc+geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(trait.2.variance)), alpha = 0.01, col = "red")+
...
if(plot.trait.3){
  the.plot.trait.vc <- the.plot.trait.vc + geom_point(data= input.scatter.plot.data, aes(x = generation.vector,y= log(trait.3.variance)), alpha = 0.01,  col = "blue" )+
...
if(plot.trait.4){
  the.plot.trait.vc <- the.plot.trait.vc + geom_point(data= input.scatter.plot.data, aes(x = generation.vector, y= log(trait.4.variance)), alpha = 0.01, col = "purple")+
