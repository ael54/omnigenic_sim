...
for(eye in 1:(length(names.of.subpopulations)/2)){
 ...
 if(length(grep("20", names.of.subpopulations[eye])) != 0) pct.20 = TRUE 
  ...
  print("Yes! Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R run successfully on QTNs!")
  ...
  source("QG_Analysis_Code/Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R")
  prediction.accuracy.GBLUP <- c(prediction.accuracy.GBLUP, r.gy) 
  print("Yes! Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R run successfully on QTNs AGAIN!")
  ...
  source("QG_Analysis_Code/Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R")
  prediction.accuracy.GBLUP <- c(prediction.accuracy.GBLUP, r.gy) 
  print("Yes! Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R run successfully on QTNs AGAIN 2!")
  ...
  source("QG_Analysis_Code/Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R")
  prediction.accuracy.GBLUP <- c(prediction.accuracy.GBLUP, r.gy) 
  print("Yes! Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R run successfully on QTNs AGAIN 3!")
  ...
  source("QG_Analysis_Code/Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R")
  prediction.accuracy.GBLUP <- c(prediction.accuracy.GBLUP, r.gy) 
  print("Yes! Run_GBLUP_Train_in_One_Pop_Validate_in_Another.R run successfully on QTNs AGAIN 4!")
