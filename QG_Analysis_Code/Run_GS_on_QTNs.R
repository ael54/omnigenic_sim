...
prediction.accuracies <- data.frame(validation.set, training.set.1, training.set.2 ,
...
prediction.accuracies <- data.frame(prediction.accuracies, prediction.accuracy.Multi.Kern.No.Epi,
