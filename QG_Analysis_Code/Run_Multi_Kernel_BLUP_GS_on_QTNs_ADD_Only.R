...
for(eye in 1:(length(names.of.subpopulations)/2)){
  ...
  #####Multi-kernel model where the additive effects of core and peripheral QTN are separate
  ...
  print("Yes! Run_Multi_Kernel_BLUP_Add_Only.R run successfully on QTNs!")
  ...
  source("QG_Analysis_Code/Run_Multi_Kernel_BLUP_Add_Only.R")
  prediction.accuracy.Multi.Kern.No.Epi <- c(prediction.accuracy.Multi.Kern.No.Epi,  r.gy.add.mult.kern)
  print("Yes! Run_Multi_Kernel_BLUP_Add_Only.R run successfully on QTNs AGAIN!")
  ...
  source("QG_Analysis_Code/Run_Multi_Kernel_BLUP_Add_Only.R")
  prediction.accuracy.Multi.Kern.No.Epi <- c(prediction.accuracy.Multi.Kern.No.Epi,  r.gy.add.mult.kern)
  print("Yes! Run_Multi_Kernel_BLUP_Add_Only.R run successfully on QTNs AGAIN 2!")
  ...
  source("QG_Analysis_Code/Run_Multi_Kernel_BLUP_Add_Only.R")
  prediction.accuracy.Multi.Kern.No.Epi <- c(prediction.accuracy.Multi.Kern.No.Epi,  r.gy.add.mult.kern)
  print("Yes! Run_Multi_Kernel_BLUP_Add_Only.R run successfully on QTNs AGAIN 3!")
  ...
  source("QG_Analysis_Code/Run_Multi_Kernel_BLUP_Add_Only.R")
  prediction.accuracy.Multi.Kern.No.Epi <- c(prediction.accuracy.Multi.Kern.No.Epi,  r.gy.add.mult.kern)
  print("Yes! Run_Multi_Kernel_BLUP_Add_Only.R run successfully on QTNs AGAIN 4!")
